...
namespace PersonelTracking
{
    public partial class FrmPositionList : Form
    {
        ...
        {
            FillGrid();
            dataGridView1.Columns[1].Visible = false; // Hide ID
            dataGridView1.Columns[4].Visible = false; // Hide DepartmentID
            dataGridView1.Columns[2].Visible = false; // Hide OldDepartmentID
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            detail.OldDepartmentID = Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[4].Value); //2 
        }
