...
namespace PersonelTracking
{
    public partial class FrmSalary : Form
    {
        ...
        private void FrmSalary_Load(object sender, EventArgs e)
        {
            ...
            {
                pnlRight.Hide();
                txtUserNo.Text = detail.UserNo.ToString(); //Added by DA
                txtName.Text = detail.Name;
                txtSurname.Text = detail.Surname; //Added by DA
                txtSalary.Text = detail.SalaryAmount.ToString();
                txtYear.Text = detail.SalaryYear.ToString(); //Added by DA
            ...
            else
            {
                ...
                if (!isUpdate)
                {
                    ...
                    else
                    {
                        ...
                        cmbMonth.SelectedIndex = -1;
                        salary = new SALARY(); //Had to be added. Not present in tutorial.   
                    }
