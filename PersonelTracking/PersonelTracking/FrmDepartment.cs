    ...
    public partial class FrmDepartment : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else 
            {
                ...
                {
                    DialogResult result = MessageBox.Show("Are you sure?", "Warening!", MessageBoxButtons.YesNo);
        ...
        {
            //if (!isUpdate) // Commneted by DA - To allow user to edit current department name
