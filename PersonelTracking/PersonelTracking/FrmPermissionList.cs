...
namespace PersonelTracking
{
    public partial class FrmPermissionList : Form
    {
        ...
        private void txtDayAmmount_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.Handled = General.IsNumber(e);
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            if (detail.PermissionID == 0)
                ...
                MessageBox.Show("You can not update any approved or disaproved permission");
            else
            {
                FrmPermission frm = new FrmPermission();
                frm.isUpdate = true;
        ...
        private void FrmPermissionList_Load(object sender, EventArgs e)
        {
            ...
            if (!UserStatic.IsAdmin)
            {
                ...
                btnDisapprove.Hide();
                btnDelete.Hide();
                btnClose.Location = new Point(485, 32);
            }
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (txtDayAmmount.Text.Trim() != "")
                list = list.Where(x => x.PermissionDayAmount == Convert.ToInt32(txtDayAmmount.Text)).ToList();
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            detail.UserNo = Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[1].Value);// Was 11
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes) 
            {
                if (detail.State == PermissionStates.Approved || detail.State == PermissionStates.Disapproved)
                    MessageBox.Show("You canot delete approved or disapproved permissions");
                else
                {
